...
2. Find the latest release or download files on the project page.
...
7. Double-click the app file to start LoST.
...
2. Install or extract it on your Windows PC.
3. Open LoST.
4. Load a 3D shape file.
5. Inspect the semantic token view.
6. Rotate the model to check each side.
7. Compare parts of the shape against the token output.
